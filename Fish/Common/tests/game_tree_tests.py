...
class GameTreeTests(unittest.TestCase):
    def __init__(self, *args, **kwargs):
        ...
        self.__p9 = Player("Bob Ross", Color.WHITE)
        self.__p10 = Player("Eric Khart", Color.BROWN)
        self.__p11 = Player("Ionut", Color.RED)
    ...
    def test_apply_to_child_states_success2(self):
        ...
        result = GameTree.apply_to_child_states(GameTree(self.__state2), lambda state: state.get_player_score(Color.RED))
    ...
    def test_apply_to_child_states_success3(self):
        ...
        result = GameTree.apply_to_child_states(GameTree(self.__state5), lambda state: state.get_player_score(Color.WHITE))
