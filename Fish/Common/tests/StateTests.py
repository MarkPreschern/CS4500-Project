...
class StateTests(unittest.TestCase):
    ...
    def init_test_fail5(self):
        ...
        with self.assertRaises(ValueError):
            state = State(self.b, players=[self.p2, self.p1, self.p3, self.p4, self.p5])

    def init_test_success(self):
        state = State(self.b, players=[self.p1, self.p2, self.p3])
    ...
    def test_place_avatar_hole(self):
        ...
        with self.assertRaises(InvalidPosition):
            ...
            state = State(new_b, players=[self.p1, self.p2, self.p3])
